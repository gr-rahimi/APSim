...
automata = atma.parse_anml_file(anml_path[AnmalZoo.RandomForest])
...
for orig_cc in tqdm(orig_automatas, unit="automata"):
    orig_atm_nodes_count.append(orig_cc.get_number_of_nodes())
    ...
    fst_stride_nodes_count.append(fst_st_atm.get_number_of_nodes())

    sec_st_atm = fst_st_atm.get_single_stride_graph()
    sec_st_atm.make_homogenous()
    minimize_automata(sec_st_atm)
    sec_stride_nodes_count.append(sec_st_atm.get_number_of_nodes())

    thd_st_atm = sec_st_atm.get_single_stride_graph()
    thd_st_atm.make_homogenous()
    minimize_automata(thd_st_atm)
    third_stride_nodes_count.append(thd_st_atm.get_number_of_nodes())


pickle.dump((orig_atm_nodes_count,fst_stride_nodes_count,sec_stride_nodes_count,third_stride_nodes_count), open("random_forest_3l.pkl","wb"))
